package com.example.admin.china_weather.Activity.db;
...
public class ChinaWeatherDB {
    /*数据库名字*/
    public static String DB_NAME = "china_weather";
    /*数据库版本*/
    ...
    public List<County> loadCounties(int cityId){
        ...
        Cursor cursor = db.query("County",null,"cuty_id = ?",new String[]{String.valueOf(cityId)},null,null,null);
        if (cursor.moveToFirst()){
            do {
